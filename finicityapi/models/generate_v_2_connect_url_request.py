...
class GenerateV2ConnectURLRequest(object):

    """Implementation of the 'Generate V2 Connect URL Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateV2ConnectURLRequest class"""
