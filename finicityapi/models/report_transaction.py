...
class ReportTransaction(object):

    """Implementation of the 'Report Transaction' model.
    ...
    Attributes:
        ...
        mtype (TransactionTypeEnum): One of the values from Transaction Types
            (optional)
        pay_statement_match_types (list of
            ReportTransactionPayStatementMatchTypesEnum): Field to indicate
            how transaction is matched with pay statement
    ...
    _names = {
        ...
        "category":'category',
        "mtype":'type',
        "pay_statement_match_types":'payStatementMatchTypes',
    ...
    def __init__(self,
                 ...
                 category=None,
                 mtype=None,
                 pay_statement_match_types=None,
                 best_representation=None,
                 security_type=None,
                 symbol=None,
                 commission=None,
                 additional_properties = {}):
        """Constructor for the ReportTransaction class"""
        ...
        self.mtype = mtype
        self.pay_statement_match_types = pay_statement_match_types
    ...
    def from_dictionary(cls,
        ...
        pay_statement_match_types = dictionary.get('payStatementMatchTypes')
