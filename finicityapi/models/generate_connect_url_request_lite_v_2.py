...
class GenerateConnectURLRequestLiteV2(object):

    """Implementation of the 'Generate Connect URL Request (lite) - V2' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateConnectURLRequestLiteV2 class"""
