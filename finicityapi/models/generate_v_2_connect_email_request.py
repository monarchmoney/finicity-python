...
class GenerateV2ConnectEmailRequest(object):

    """Implementation of the 'Generate V2 Connect Email Request' model.
    ...
    Attributes:
        ...
        customer_id (string): The customerID from the Add Customer call.
        consumer_id (string): The consumerID from the Create Customer call.
            <br> Note: Required for any connect type that generates a report.
        ...
        experience (string): The `experience` field allows you to customize:
            ...
            **unique ID**: the code for a different experience
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateV2ConnectEmailRequest class"""
