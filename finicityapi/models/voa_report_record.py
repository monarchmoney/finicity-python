...
class VOAReportRecord(object):
    ...
    Attributes:
        ...
        institutions (list of VOAReportInstitution): A list of institution
    ...
    def __init__(self,
        ...
        """Constructor for the VOAReportRecord class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('institutions') != None:
            ...
            for structure in dictionary.get('institutions'):
                institutions.append(finicityapi.models.voa_report_institution.VOAReportInstitution.from_dictionary(structure))
