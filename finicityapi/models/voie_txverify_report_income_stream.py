...
import finicityapi.models.voie_txverify_report_transaction

class VOIETxverifyReportIncomeStream(object):

    """Implementation of the 'VOIE TXVerify Report Income Stream' model.
    ...
    Attributes:
        ...
        average_monthly_income_net (float): Monthly average amount over the
            previous 24 months
        transactions (list of VOIETxverifyReportTransaction): A list of
            transaction records
    ...
    def __init__(self,
        ...
        """Constructor for the VOIETxverifyReportIncomeStream class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('transactions') != None:
            ...
            for structure in dictionary.get('transactions'):
                transactions.append(finicityapi.models.voie_txverify_report_transaction.VOIETxverifyReportTransaction.from_dictionary(structure))
