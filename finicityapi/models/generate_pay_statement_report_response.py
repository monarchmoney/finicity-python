...
class GeneratePayStatementReportResponse(object):

    """Implementation of the 'Generate Pay Statement Report Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GeneratePayStatementReportResponse class"""
