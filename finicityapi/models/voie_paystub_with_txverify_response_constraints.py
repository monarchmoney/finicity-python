...
import finicityapi.models.voie_with_interview_data
import finicityapi.models.report_custom_field

class VOIEPaystubWithTxverifyResponseConstraints(object):

    """Implementation of the 'VOIE - Paystub (with TXVerify) Response Constraints' model.
    ...
    Attributes:
        account_ids (list of string): Specific accountIds to be included in
            the new report.
        voie_with_interview_data (VOIEWithInterviewData): TODO: type
            description here.
    ...
    def __init__(self,
                 voie_with_interview_data=None,
                 account_ids=None,
                 report_custom_fields=None,
                 additional_properties = {}):
        """Constructor for the VOIEPaystubWithTxverifyResponseConstraints class"""

        # Initialize members of the class
        self.account_ids = account_ids
        self.voie_with_interview_data = voie_with_interview_data
    ...
    def from_dictionary(cls,
        ...
        voie_with_interview_data = finicityapi.models.voie_with_interview_data.VOIEWithInterviewData.from_dictionary(dictionary.get('voieWithInterviewData')) if dictionary.get('voieWithInterviewData') else None
        ...
        return cls(voie_with_interview_data,
                   account_ids,
