...
import finicityapi.models.voa_report_transaction
import finicityapi.models.asset_summary
import finicityapi.models.account_detail

class VOAReportAccount(object):

    """Implementation of the 'VOA Report Account' model.
    ...
    Attributes:
        ...
        average_monthly_balance (float): The average monthly balance of this
            account
        transactions (list of VOAReportTransaction): An array of transactions
    ...
    def __init__(self,
        ...
        """Constructor for the VOAReportAccount class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('transactions') != None:
            ...
            for structure in dictionary.get('transactions'):
                transactions.append(finicityapi.models.voa_report_transaction.VOAReportTransaction.from_dictionary(structure))
