...
import finicityapi.models.asset_summary_report_institution
import finicityapi.models.asset_summary

class AssetSummaryReportRecord(object):

    """Implementation of the 'Asset Summary Report Record' model.
    ...
    Attributes:
        ...
        institutions (list of AssetSummaryReportInstitution): A list of
    ...
    def __init__(self,
        ...
        """Constructor for the AssetSummaryReportRecord class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('institutions') != None:
            ...
            for structure in dictionary.get('institutions'):
                institutions.append(finicityapi.models.asset_summary_report_institution.AssetSummaryReportInstitution.from_dictionary(structure))
