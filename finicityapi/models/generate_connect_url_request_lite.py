...
class GenerateConnectURLRequestLite(object):

    """Implementation of the 'Generate Connect URL Request (lite)' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateConnectURLRequestLite class"""
