...
class AppStatusV1(object):

    """Implementation of the 'App Status V1' model.
    ...
    Attributes:
        ...
        eua_id (string): The official applicationId to be used in customer
            creation and setting customer application Id services. This is
            populated after the app is in A status for approved.
    ...
    def __init__(self,
        ...
        """Constructor for the AppStatusV1 class"""
