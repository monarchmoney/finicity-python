...
class GenerateConnectURLRequestLending(object):

    """Implementation of the 'Generate Connect URL Request (Lending)' model.
    ...
    Attributes:
        ...
        institution_id (int): ID of the specific Institution login flow to
            present to the Customer/Consumer. For any lending and report type
            flow this will present this institution first to the customer to
            add and then they may add additional institutions after this first
            default one.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateConnectURLRequestLending class"""
