...
class VOIReportIncomeStreamRecord(object):

    """Implementation of the 'VOI Report Income Stream Record' model.

    VOI Report Income Stream Record
    ...
    Attributes:
        ...
        average_monthly_income_net (float): Monthly average amount over the
            previous 24 months
        transactions (list of VOIReportTransactionRecord): A list of
            transaction records
    ...
    def __init__(self,
        ...
        """Constructor for the VOIReportIncomeStreamRecord class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('transactions') != None:
            ...
            for structure in dictionary.get('transactions'):
                transactions.append(finicityapi.models.voi_report_transaction_record.VOIReportTransactionRecord.from_dictionary(structure))
