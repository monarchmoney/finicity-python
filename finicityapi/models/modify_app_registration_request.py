...
class ModifyAppRegistrationRequest(object):

    """Implementation of the 'Modify App Registration Request' model.

    Body for the request when you are submitting and app modification request

    Attributes:
        app_description (string): A short description of the app. This will be
            visible to end users in the FI interface.
        app_name (string): App Name. This will be visible to end users in the
            FI interface.
        app_url (string): App URL. This will be visible to end users in the FI
            interface.
        ...
        owner_name (string): Business name for business entity that owns the
            app. Information for registration purposes only and not given to
            the end user.
        owner_postal_code (int): Zip code for business entity that owns the
            app. Information for registration purposes only and not given to
            the end user.
    ...
    def __init__(self,
        ...
        """Constructor for the ModifyAppRegistrationRequest class"""
