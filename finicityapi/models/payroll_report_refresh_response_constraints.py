...
import finicityapi.models.payroll_provider_refresh_response_data
import finicityapi.models.report_custom_field

class PayrollReportRefreshResponseConstraints(object):

    """Implementation of the 'Payroll Report Refresh Response Constraints' model.

    TODO: type model description here.

    Attributes:
        payroll_provider_data (list of PayrollProviderRefreshResponseData):
    ...
    def __init__(self,
        ...
        """Constructor for the PayrollReportRefreshResponseConstraints class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('payrollProviderData') != None:
            ...
            for structure in dictionary.get('payrollProviderData'):
                payroll_provider_data.append(finicityapi.models.payroll_provider_refresh_response_data.PayrollProviderRefreshResponseData.from_dictionary(structure))
        report_custom_fields = None
