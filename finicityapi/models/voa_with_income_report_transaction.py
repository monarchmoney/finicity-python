...
class VOAWithIncomeReportTransaction(object):

    """Implementation of the 'VOA with Income Report Transaction' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VOAWithIncomeReportTransaction class"""
