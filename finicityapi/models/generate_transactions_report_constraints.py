...
class GenerateTransactionsReportConstraints(object):

    """Implementation of the 'Generate Transactions Report Constraints' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateTransactionsReportConstraints class"""
