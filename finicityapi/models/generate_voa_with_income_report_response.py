...
class GenerateVOAWithIncomeReportResponse(object):

    """Implementation of the 'Generate VOA With Income Report Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateVOAWithIncomeReportResponse class"""
