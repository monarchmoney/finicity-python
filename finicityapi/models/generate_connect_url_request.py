...
class GenerateConnectURLRequest(object):

    """Implementation of the 'Generate Connect URL Request' model.
    ...
    Attributes:
        ...
        institution_id (int): ID of the specific Institution login flow to
            present to the Customer/Consumer <br> *Only supported for connect
            type`lite`*
        institution_login_id (string): The institutionLoginId for the account
            ...
            specific set of accounts under one institutionLoginId
    ...
    def __init__(self,
        ...
        """Constructor for the GenerateConnectURLRequest class"""
