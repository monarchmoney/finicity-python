...
import finicityapi.models.voa_with_income_report_institution
import finicityapi.models.asset_summary

class VOAWithIncomeReportRecord(object):

    """Implementation of the 'VOA with Income Report Record' model.
    ...
    Attributes:
        ...
        institutions (list of VOAWithIncomeReportInstitution): A list of
    ...
    def __init__(self,
        ...
        """Constructor for the VOAWithIncomeReportRecord class"""
