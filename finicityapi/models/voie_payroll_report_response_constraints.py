...
class VOIEPayrollReportResponseConstraints(object):

    """Implementation of the 'VOIE - Payroll Report Response Constraints' model.
    ...
    def __init__(self,
        ...
        """Constructor for the VOIEPayrollReportResponseConstraints class"""
