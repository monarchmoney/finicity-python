...
class ExpiredTokenException(finicityapi.exceptions.api_exception.APIException):
    def __init__(self, reason, context):
        """Constructor for the ExpiredTokenException class
        ...
        """
        super(ExpiredTokenException, self).__init__(reason, context)
