...
from finicityapi.http.http_context import HttpContext
from finicityapi.http.requests_client import RequestsClient
from finicityapi.exceptions.expired_token_exception import ExpiredTokenException
...
class BaseController(object):
    ...
    def validate_response(self, context):
        ...
        if (context.response.status_code < 200) or (context.response.status_code > 208): #[200,208] = HTTP OK
            raise ExpiredTokenException('The token has expired.', context)
